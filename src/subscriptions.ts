...
export const SUBSCRIPTIONS: Subscription[] = [
...

  {
    ...
    provider: 'Zhipu AI',
    providerId: 'zhipuai',
    description: '智谱清言 — Zhipu AI\'s assistant powered by GLM-5.3. Consumer chat is free on open-source GLM-4.7; the paid GLM Coding Plan is the flagship offering. Individual plans save 30% billed yearly (20% quarterly); Team seats save 10% annually.',
    category: 'chat',
